...
export const newCartItem = {
  id: '54678e13dc04e1b803b500a9gh45',
  fulfillmentMethod: 'Pickup',
  purchaseLocation: null,
  fulfillmentLocationCode: 'SACRAMENTO',
  productDiscounts: [],
  ...
  total: 100,
  product: {
    productCode: 'BackP_045',
    fulfillmentTypesSupported: ['DirectShip', 'InStorePickup'],
    name: 'Adidas 50 Pack',
    description:
      'The JanSport Adidas 50 pack for weekend trips has adjustable torso, vented back panel, great organization and plenty of straps, so you can wrangle your load while keeping the gear accessible.',
    imageUrl: '//cdn-sb.mozu.com/29927-49696/cms/49696/files/1b6b9ecd-912a-412f-8d11-c2660d265aff',
    options: [],
    properties: [
      {
        attributeFQN: 'tenant~availability',
